    ...
    <div className="min-h-screen bg-[#0a0a2e] py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* First Row */}
          <div className="bg-white p-6 text-center h-[140px] flex flex-col items-center justify-center relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:ml-[25%]">
          <div className="bg-white p-6 text-center h-[140px] flex flex-col items-center justify-center relative order-3 md:order-1">
          ...
          <div className="bg-white p-6 text-center h-[140px] flex flex-col items-center justify-center relative order-2">
          ...
          <div className="bg-white p-6 text-center h-[140px] flex flex-col items-center justify-center relative order-1 md:order-3">
        ...
        <div className="hidden md:block absolute top-1/2 left-[50%] transform -translate-x-1/2 -translate-y-1/2">
          <div className="w-8 h-[2px] bg-[#0066ff]"></div>
